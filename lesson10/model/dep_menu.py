...
# functions
def show_all_departments(update: Update, context: CallbackContext):
    try:
        data = manipulator.show_all_departments()
    except Exception:
        text = "Error =("
    else:
        text = ""
...
#worker CH
menu_handlers = [
    CallbackQueryHandler(show_all_departments, pattern='^'+SHOW_DATA+'$'),
